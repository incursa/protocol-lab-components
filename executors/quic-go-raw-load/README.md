...
```text
org.protocol-lab.components.executor.quic-go-raw-load.0.1.12.<rid>.plabpkg
```
...
Version `0.1.12` adds exact-content sustained 256x64KiB server-to-client downloads.
