...
$componentName='openssl-tls13-key-update-executor';$componentRoot=Join-Path $Root "executors/$componentName"
$build=& (Join-Path $PSScriptRoot 'Invoke-OpenSslTls13KeyUpdateBuild.ps1') -Kind executor -RuntimeIdentifier $RuntimeIdentifier -Root $Root
