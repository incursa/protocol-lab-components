...
if($manifest.packageVersion-ne '0.3.0'){throw 'DoT scenario package version must be 0.3.0.'}
if((@($manifest.providedSuites.suiteId)-join ',')-ne 'dns-dot-performance-smoke,dns-dot-interoperability-smoke,dns-dot-resolver-interoperability-smoke'){throw 'DoT scenario package providedSuites mismatch.'}
