...
if (@($tls12Selection.selectedComponents.componentId | Sort-Object) -join ',' -ne 'dotnet-sslstream-tls13,gnutls-serv,go-tls12,go-tls12-executor,go-tls13,go-tls13-chacha20,go-tls13-executor,go-tls13-mtls,go-tls13-mtls-executor,go-utls-tls13-chacha20-executor,openssl-s-server,openssl-tls13-key-update,openssl-tls13-key-update-executor,rustls-tls13,rustls-tls13-early-data,rustls-tls13-early-data-executor,s2n-tls13,tls-handshake-scenarios,wolfssl-tls13') {
