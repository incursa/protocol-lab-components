...
$targetArchive = Resolve-One 'org.protocol-lab.components.implementation.aioquic-http3.0.3.0.plabpkg'
...
$targetImage = 'incursa-protocol-lab-aioquic-http3:0.3.0-extracted-smoke'
