...
if($manifest.packageVersion-ne'0.1.1'){throw 'HTTP/2 WebSocket scenario package version must be 0.1.1.'}
...
if((@($manifest.providedLoadProfiles.loadProfileId)-join ',')-ne'websocket-smoke,websocket-comparison,diagnostic'){throw 'HTTP/2 WebSocket load-profile declarations mismatch.'}
