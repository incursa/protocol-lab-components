...
if (@($tls12Selection.selectedComponents.componentId | Sort-Object) -join ',' -ne 'dotnet-sslstream-tls13,gnutls-serv,go-tls12,go-tls12-executor,go-tls13,go-tls13-chacha20,go-tls13-executor,go-utls-tls13-chacha20-executor,openssl-s-server,rustls-tls13,s2n-tls13,tls-handshake-scenarios,wolfssl-tls13') {
