...
const (
	implementationID      = "go-http1-websocket"
...
func main() {
	listenAddress := envOr("PLAB_HTTP1_WEBSOCKET_LISTEN", net.JoinHostPort("127.0.0.1", envOr("PLAB_TARGET_PORT", "18081")))
	...
	ready := map[string]any{
		...
		"protocolVariant": "websocket-h1-cleartext-upgrade", "binding": "rfc6455-http1-upgrade",
		"transportSecurity": "cleartext", "path": "/websocket",
	}
