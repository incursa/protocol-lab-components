...
`org.protocol-lab.components.implementation.go-http1-websocket-tls@0.1.0`
is an independent Go standard-library origin for the five exact RFC 6455 TLS
smoke identities. It accepts only TLS 1.3 with ALPN `http/1.1`, presents the
