...
| Authoritative secure DNS | `bind9-dot@0.1.0#de8abf6e9353...`; `bind9-doh2@0.1.0` | live-proven | DoT `job-4568f06d29494058995f2a3bf7dab774` and DoH2 `job-3e256dd1cb8a4f668464e2cd5e0eac7e` passed validation and retained selected-target provenance |
| Classic authoritative DNS | `bind9-classic-authority@0.1.0#6682fdf29e51...` | live-proven and published | UDP `job-88d1dbab8b6a40b7b43992995a02b219` and TCP `job-799e5c5f78f44fb4805a23a2ff6a8744`: exact transport validation passed, accepted measurements were retained, and skipped cross-bindings remained metric-free |
| Technitium encrypted authoritative DNS | DoT/DoH2/DoH3/DoQ candidates | closed-by-decision | Package-local decision READMEs retain the exact ALPN, response-header, cipher-control, and platform-QUIC contract mismatches |
