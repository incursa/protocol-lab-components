...
Package version `0.1.2` runs digest-pinned Unbound 1.22.0 as the measured native DNS-over-HTTPS HTTP/2 recursive resolver. The image's own libnghttp2-backed listener terminates TLS and HTTP/2; no reverse proxy or protocol adapter substitutes for Unbound.
