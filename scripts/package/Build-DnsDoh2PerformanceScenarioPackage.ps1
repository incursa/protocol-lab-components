...
if($manifest.packageVersion-ne '0.2.0'){throw 'DoH2 scenario package version must be 0.2.0.'}
if((@($manifest.providedSuites.suiteId)-join ',')-ne 'dns-doh2-performance-smoke,dns-doh2-interoperability-smoke'){throw 'DoH2 scenario package providedSuites mismatch.'}
