...
$packageBuilds = @(
    ...
    [pscustomobject]@{ componentPath = 'implementations/kestrel-http2-websocket'; script = 'Build-KestrelHttp2WebSocketPackage.ps1'; arguments = @('win-x64') },
    [pscustomobject]@{ componentPath = 'implementations/kestrel-http2-websocket'; script = 'Build-KestrelHttp2WebSocketPackage.ps1'; arguments = @('linux-x64') },
    [pscustomobject]@{ componentPath = 'implementations/jetty-http2-websocket'; script = 'Build-JettyHttp2WebSocketPackage.ps1'; arguments = @() },
    ...
    [pscustomobject]@{ componentPath = 'implementations/go-dns-doh3'; script = 'Build-GoDnsDoh3Package.ps1'; arguments = @('win-x64') },
    ...
    [pscustomobject]@{ componentPath = 'implementations/caddy-http2'; script = 'Build-CaddyHttp2Package.ps1'; arguments = @() },
    ...
    [pscustomobject]@{ componentPath = 'implementations/h2o-http3'; script = 'Build-H2oHttp3Package.ps1'; arguments = @() },
    ...
    [pscustomobject]@{ componentPath = 'implementations/quinn-raw'; script = 'Build-QuinnRawPackage.ps1'; arguments = @() },
    [pscustomobject]@{ componentPath = 'implementations/s2n-quic-raw'; script = 'Build-S2nQuicRawPackage.ps1'; arguments = @() },
    [pscustomobject]@{ componentPath = 'implementations/picoquic-raw'; script = 'Build-PicoquicRawPackage.ps1'; arguments = @() },
    ...
    [pscustomobject]@{ componentPath = 'implementations/neqo-http3'; script = 'Build-NeqoHttp3Package.ps1'; arguments = @() },
    [pscustomobject]@{ componentPath = 'implementations/xquic-http3'; script = 'Build-XquicHttp3Package.ps1'; arguments = @() },
    [pscustomobject]@{ componentPath = 'executors/curl-http3-client'; script = 'Build-CurlHttp3ClientPackage.ps1'; arguments = @() },
    [pscustomobject]@{ componentPath = 'executors/xquic-http3-client'; script = 'Build-XquicHttp3ClientPackage.ps1'; arguments = @() },
    ...
    [pscustomobject]@{ componentPath = 'executors/go-tls13-mtls-executor'; script = 'Build-GoTls13MtlsExecutorPackage.ps1'; arguments = @('linux-x64') },
    [pscustomobject]@{ componentPath = 'executors/go-utls-tls13-chacha20-executor'; script = 'Build-GoUtlsTls13Chacha20ExecutorPackage.ps1'; arguments = @('win-x64') },
    [pscustomobject]@{ componentPath = 'executors/go-utls-tls13-chacha20-executor'; script = 'Build-GoUtlsTls13Chacha20ExecutorPackage.ps1'; arguments = @('linux-x64') },
    [pscustomobject]@{ componentPath = 'executors/openssl-tls13-key-update-executor'; script = 'Build-OpenSslTls13KeyUpdateExecutorPackage.ps1'; arguments = @('win-x64') },
    [pscustomobject]@{ componentPath = 'executors/openssl-tls13-key-update-executor'; script = 'Build-OpenSslTls13KeyUpdateExecutorPackage.ps1'; arguments = @('linux-x64') },
    [pscustomobject]@{ componentPath = 'executors/go-tls12-executor'; script = 'Build-GoTls12ExecutorPackage.ps1'; arguments = @('win-x64') },
    [pscustomobject]@{ componentPath = 'executors/go-tls12-executor'; script = 'Build-GoTls12ExecutorPackage.ps1'; arguments = @('linux-x64') },
    ...
    [pscustomobject]@{ componentPath = 'executors/go-dns-doh3-executor'; script = 'Build-GoDnsDoh3ExecutorPackage.ps1'; arguments = @('win-x64') },
    ...
    [pscustomobject]@{ componentPath = 'scenarios/http2-websocket-performance'; script = 'Build-Http2WebSocketScenarioPackage.ps1'; arguments = @() },
