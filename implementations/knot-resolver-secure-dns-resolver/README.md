...
Package version `0.1.2` runs digest-pinned Knot Resolver 6.4.0 as the measured native DNS-over-TLS and DNS-over-HTTPS HTTP/2 recursive resolver. Knot Resolver's own listeners terminate TLS and HTTP/2; no reverse proxy or protocol adapter substitutes for the resolver.
